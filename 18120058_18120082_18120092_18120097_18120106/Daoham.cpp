...
void XetDau23(float a, float b, float c, float d, float e)
{
	...
	else
	{
		...
		else
		{
			...
			GiaiPT_Bac2(a * d, 2 * a * e, b * e - c * d, x4, x5, l);
			if (k == -1 || k == 0)
			{
				a = 1;
				b = b / a;
				...
				if (d > 0)
				{
					...
					{
						if (l == -1)
							fprintf(output, "Dao ham duong tren (%.2f,+oo)\n", -e / d);
						if (l == 0) {
							if (x3 < x4)
							{
								fprintf(output, "Dao ham luong duong voi x thuoc (%.2f,%.2f)v(%.2f,+oo)\n", x3, x4, x4);
								fprintf(output, "Dao ham bang 0 voi x=%.2f\n", x4);
							}
							if (x3 >= x4)
							{
						...
						if (l == 2) {
							if (x3 < x4) {
								fprintf(output, "Dao ham luong duong voi x thuoc (%.2f,%.2f)v(%.2f,+oo)\n", x3, x4, x5);
								fprintf(output, "Dao ham bang 0 voi x1=%.2f   x2=%.2f\n", x4, x5);
							}
							if (x3 >= x4 && x3 < x5) {
								fprintf(output, "Dao ham duong tren (%.2f,+oo)\n", x5);
							}
				...
				else
				{
					...
					{
						if (l == -1)
							fprintf(output, "Dao ham am tren (-oo,%.2f)\n", -e / d);
						if (l == 0) {
							if (x3 <= x4)
							{
								fprintf(output, "Dao ham luong am voi x thuoc (-oo,%.2f)\n", x3);
							}
							if (x3 > x4)
							{
								fprintf(output, "Dao ham am tren (-oo,%.2f)v(%.2f,%.2f)\n", x4, x4, x3);
								fprintf(output, "Dao ham bang 0 tai x=%.2f\n", x4);
							}
						}
						if (l == 2) {
							...
							if (x3 > x4 && x3 <= x5) {
								fprintf(output, "Dao ham duong tu (%.2f,%.2f)\n", x4, x3);
								fprintf(output, "Dao ham am tren (-oo,%.2f)\n", x4);
								fprintf(output, "Dao ham bang 0 tai x=%.2f\n", x4);
							}
							if (x3 > x5) {
								fprintf(output, "Dao ham duong tren (%.2f,%.2f)\n", x4, x5);
								fprintf(output, "Dao ham am tren (-oo,%.2f)v(%.2f,%.2f)\n", x4, x5, x3);
								fprintf(output, "Dao ham bang 0 tai x1=%.2f  x2=%.2f\n", x4, x5);
							}
						}
					}
				}
			...
			else
			{
				...
				if (a > 0)
				{
					...
					{
						if (l == -1) {
							fprintf(output, "Dao ham duong voi x thuoc (%.2f,+oo)\n", x3);
						}
						if (l == 0) {
							if (x3 >= x4) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,+oo)\n", x3);
							...
							if (x3 < x4) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)v(%.2f,+oo)\n", x3, x4, x4);
								fprintf(output, "Dao ham bang 0 voi x=%.2f\n", x4);
							}
						...
						if (l == 2) {
							if (x3 < x4) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)v(%.2f,+oo)\n", x3, x4, x5);
								fprintf(output, "Dao ham am voi x thuoc (%.2f,%.2f)\n", x4, x5);
								fprintf(output, "Dao ham bang 0 tai x1=%.2f  x2=%.2f\n", x4, x5);
							}
							if (x3 >= x4 && x3 < x5) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,+oo)\n", x5);
					...
					else
					{
						...
						{
							if (l == -1) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,+oo)\\{%.2f}\n", x1, x2);
							}
							if (l == 0) {
								if (x1 >= x4) {
									fprintf(output, "Dao ham duong voi x thuoc (%.2f,+oo)\\{%.2f}\n", x1, x2);
								...
								if (x1 < x4) {
									fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)v(%.2f,+oo)\\{%.2f}\n", x1, x4, x4, x2);
									fprintf(output, "Dao ham bang 0 voi x=%.2f\n", x4);
								}
							...
							if (l == 2) {
								if (x1 < x4) {
									fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)v(%.2f,+oo)\\{%.2f}\n", x1, x4, x5, x2);
									fprintf(output, "Dao ham am voi x thuoc (%.2f,%.2f)\\{%.2f}\n", x4, x5, x2);
									fprintf(output, "Dao ham bang 0 tai x1=%.2f  x2=%.2f\n", x4, x5);
								}
								if (x3 >= x4 && x3 < x5) {
									fprintf(output, "Dao ham duong voi x thuoc (%.2f,+oo)\\{%.2f}\n", x5, x2);
						...
						else
						{
							...
							if (l == 2) {
								if (x4 <= x1) {
									...
									if (x5 > x3) {
										fprintf(output, "Dao ham duong voi x thuoc  (%.2f,+oo)\n", x5);
										fprintf(output, "Dao ham am voi x thuoc (%.2f,%.2f)v(%.2f,%.2f)\n", x1, x2, x3, x5);
										fprintf(output, "Dao ham bang 0 voi x=%.2f\n", x5);
									}
								}
								if (x4 > x1 && x4 < x2) {
									if (x5 < x2) {
										fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)v(%.2f,%.2f) v (%.2f,+oo)\n", x1, x4, x5, x2, x3);
										fprintf(output, "Dao ham am voi x thuoc (%.2f,%.2f)\n", x4, x5);
										fprintf(output, "Dao ham bang 0 voi x1=%.2f  x2=%.2f\n", x4, x5);
									}
									if (x5 >= x2 && x5 <= x3) {
				...
				if (a < 0)
				{
					if (x1 == x2) {
						if (l == -1) {
							fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) \\ {%.2f}\n", x3, x1);
						}
						if (l == 0) {
							fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) \\ {%.2f}\n", x3, x1);
						}
						if (l == 2) {
							...
							if (x3 > x4 && x3 <= x5) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)\\{%.2f}\n", x4, x3, x1);
								fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) \\ {%.2f}\n", x4, x1);
							}
							if (x3 > x5) {
								fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)\\{%.2f}\n", x4, x5, x1);
								fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f)v(%.2f,%.2f)\\ {%.2f}\n", x4, x5, x3, x1);
							}
						}
					}
					else
					{
						...
						{
							if (l == -1) {
								fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) \n", x1);
								if (l == 0) {
									fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) \n", x1);
								}
								if (l == 2) {
									...
									if (x1 > x4 && x1 <= x5) {
										fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)\n", x4, x1);
										fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) \n", x4);
									}
									if (x1 > x5) {
										fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)\n", x4, x5);
										fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f)v(%.2f,%.2f)\n", x4, x5, x1);
									}
								}
							}
							else
							{
								...
								if (l == 0) {
									fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f)v(%.2f,%.2f) v (%.2f,%.2f)\n", x4, x5, x1, x2, x3);
								}
								if (l == 2) {
									if (x4 < x1) {
										if (x5 < x1) {
										...
										if (x5 > x2 && x5 < x3) {
											fprintf(output, "Dao ham duong voi x thuoc (%.2f,%.2f)v(%.2f,%.2f)\n", x4, x1, x2, x5);
											fprintf(output, "Dao ham am voi x thuoc (-oo,%.2f) v (%.2f,%.2f)\n", x4, x5, x3);
											fprintf(output, "Dao ham bang 0 voi x1=%.2f  x2=%.2f\n", x4, x5);
										}
										if (x5 >= x3) {
